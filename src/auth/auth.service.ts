...
export class AuthService {
  ...
  async localSignup(
    ...
    try {
      ...
      const user = await this.operatorService.findOneByEmail(userDetails.email);
      ...
      const newUser = await this.operatorService.create({
        ...userDetails,
        password: hash,
      });
  ...
  async localLogin(
    ...
    try {
      const user = await this.operatorService.findOneByEmail(
